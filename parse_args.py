...
argparser.add_argument('--intra_ssl_temperature', type=float, default=0.05)

argparser.add_argument('--inter_ssl_temperature', type=float, default=0.05)

argparser.add_argument('--intra_ssl_reg', type=float, default=0.00001)

argparser.add_argument('--inter_ssl_reg', type=float, default=0.00001)
...
argparser.add_argument('--decoder_type', default=1, type=int, help='different type of decoder')
